...
👋 Hey there! I'm Eldiiar — a passionate **Frontend Developer** with **3+ years of experience** building products in **fintech** and **e-commerce**.

I specialize in crafting fast, scalable, and visually polished web applications using **React**, **Next.js**, and **Vue.js**. I've led a team of 5 developers, shipped CI/CD pipelines, implemented FSD architecture, and grew user engagement by **20%** via PWA. I care deeply about clean code, great UX, and shipping things that actually matter.

🚀 Right now I'm actively leveling up my **backend skills** with **Node.js** and **Nest.js** — on my way to becoming a well-rounded **FullStack Developer**. If you're building something cool and need someone who brings both frontend craft and backend curiosity, let's talk!
...
<div>
  <a href='https://leetcode.com/u/eld11ar/' target='_blank'>
    <img alt='leetcode' src='https://img.shields.io/badge/dynamic/json?style=for-the-badge&labelColor=black&color=%23ffa116&label=Solved&query=solvedOverTotal&url=https%3A%2F%2Fleetcode-badge.vercel.app%2Fapi%2Fusers%2Feld11ar&logo=leetcode&logoColor=yellow'/>
  </a>
</div>
